...
import 'package:catatan/presentation/pages/homepage/desktop/desktop_home.dart';
import 'package:catatan/presentation/pages/homepage/mobile/mobile_home.dart';
import 'package:catatan/presentation/pages/login/desktop/desktop_login.dart';
          ...
          MaterialApp(
            ...
            home: Builder(
              builder: (context) {
                ...
                return DesktopHome(user: snapshot);
              }
            ),
          )
          :
